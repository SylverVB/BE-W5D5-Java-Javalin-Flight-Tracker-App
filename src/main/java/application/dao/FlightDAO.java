...
public class FlightDAO {
     ...
     * to retrieve the generated ID automatically. That means that when you insert the flight, you only need
     * to define the departure_city and arrival_city values (two columns total!)
     *
     * The task is to change the sql String and set preparedStatement parameters.
     *
     ...
     *
     * The format of an update PreparedStatement written as a Java String looks something like this:
     ...
     *
     * The format of a select where statement written as a Java String looks something like this:
